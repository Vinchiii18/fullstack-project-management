  ...
  try {
    ...
    if (
      ...
      return res.status(403).json({
        message:
          "You don't have permission to create projects in this worksapce!",
      });
    }
    ...
    // Add memberse to project if they are in the workspace
...
export const updateProject = async (req, res) => {
  try {
    ...
    res.json({ project, message: "Project updated sucessfully" });
  } catch (error) {
    console.log(error);
    res.status(500).json({ message: error.code || error.message });
  }
